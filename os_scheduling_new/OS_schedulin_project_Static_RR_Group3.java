...
public class OS_schedulin_project_Static_RR_Group3 {

  public static LinkedList<Job> AllJobs = new LinkedList<Job>();      //all Valid jobs queue
    ...
    static int TQuantum = 8;//Time Quantum for Rounds robin , 5+3 , 3 is team num.
